...
public class MainActivity extends Activity
{
	...
	//Fix: Shouldn't we be using "GLSurf" class that extends
	//the base class of GLSurfaceView??
	protected GLSurf glSurfaceView;

	/** Hack to attempt to get past null pointer exception. **/
	protected boolean hasSurfaceView = false;

	/** calling the surface view will eventually call the
	 *  renderer. If the renderer is null, this will
	 *  create a null pointer exception. Adding this guard
	 *  because it was the one in Kevin Brothaler's book
	 *  that was used.
	 *
	 *  So the "hasSurfaceView" guard was close. But not
	 *  the correct gaurd.
	 */
	...
	protected void onCreate(Bundle savedInstance)
	{
		...
		//BUGFIX: GLSurfaceView --> GLSurf refactor.
		glSurfaceView = new GLSurf(this); //typo in tutorial.
		hasSurfaceView = true;
